...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_LargeShip_StandardHull_Art_Interior_Map_Deck.BP_LargeShip_StandardHull_Art_Interior_Map_Deck_C.UserConstructionScript");
