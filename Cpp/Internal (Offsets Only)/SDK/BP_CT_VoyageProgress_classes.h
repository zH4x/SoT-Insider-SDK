...
public:
	...
	unsigned char                                      UnknownData_L19N[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_CT_VoyageProgress.BP_CT_VoyageProgress_C");
		return ptr;
	}
