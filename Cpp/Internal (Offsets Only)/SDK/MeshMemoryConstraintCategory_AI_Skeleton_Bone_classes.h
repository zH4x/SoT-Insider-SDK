...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass MeshMemoryConstraintCategory_AI_Skeleton_Bone.MeshMemoryConstraintCategory_AI_Skeleton_Bone_C");
		return ptr;
	}
