...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_fod_Devilfish_03_FirelightRaw_00_a_ItemDesc.BP_fod_Devilfish_03_FirelightRaw_00_a_ItemDesc_C");
		return ptr;
	}
