...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.AINameplateComponent.OnRep_DisplayName");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.AmbientWaterSpawnerManager.OnPlayerDeath");
...
// Function AthenaAI.CoralShieldVFXComponent.OnRep_IsVFXActive
// (Final, Native, Private)
void UCoralShieldVFXComponent::OnRep_IsVFXActive()
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.CoralShieldVFXComponent.OnRep_IsVFXActive");

	UCoralShieldVFXComponent_OnRep_IsVFXActive_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.SpawnContextProviderZone.RemoveContextsFromTarget");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.SpawnContextProviderZone.AddContextsToTarget");
