...
public:
	...
	unsigned char                                      UnknownData_RYWM[0x4];                                     // 0x042C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryRank2_MA.BP_PromptActor_EmissaryRank2_MA_C");
		return ptr;
	}
