...
{
	unsigned char                                      UnknownData_VC6T[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AJAX[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_O0E5[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
