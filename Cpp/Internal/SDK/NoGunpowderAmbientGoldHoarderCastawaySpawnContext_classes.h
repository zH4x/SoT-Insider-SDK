...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass NoGunpowderAmbientGoldHoarderCastawaySpawnContext.NoGunpowderAmbientGoldHoarderCastawaySpawnContext_C");
		return ptr;
	}
