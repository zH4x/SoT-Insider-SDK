...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass EmissaryEncounteredAIShip_OOS_PromptAccessKey.EmissaryEncounteredAIShip_OOS_PromptAccessKey_C");
		return ptr;
	}
