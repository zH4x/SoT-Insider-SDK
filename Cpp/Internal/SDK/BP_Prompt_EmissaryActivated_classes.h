...
public:
	...
	unsigned char                                      UnknownData_UG67[0x7];                                     // 0x0189(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Prompt_EmissaryActivated.BP_Prompt_EmissaryActivated_C");
		return ptr;
	}
