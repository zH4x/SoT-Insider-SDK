...
public:
	...
	unsigned char                                      UnknownData_HMBM[0x4];                                     // 0x042C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryRank5_OOS.BP_PromptActor_EmissaryRank5_OOS_C");
		return ptr;
	}
