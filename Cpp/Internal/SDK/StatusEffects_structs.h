...
struct FStatus
{
	...
	unsigned char                                      UnknownData_N9GE[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FBuffedTargetData
{
	...
	TScriptInterface<class UStatusEffectRecipientInterface> StatusEffectRecipient;                                     // 0x0008(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper)
...
{
	unsigned char                                      UnknownData_L3X2[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FDelayedStatusEffect
{
	...
	unsigned char                                      UnknownData_FGOO[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FActiveStatusEffect
{
	...
	unsigned char                                      UnknownData_5H9G[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UW4O[0x17];                                    // 0x0039(0x0017) MISSED OFFSET (PADDING)
