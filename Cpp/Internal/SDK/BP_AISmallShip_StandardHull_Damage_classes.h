...
public:
	...
	class UChildActorComponent*                        Damage_Zone_Lower_02;                                      // 0x0638(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	class UChildActorComponent*                        Damage_Zone_Lower_11;                                      // 0x0640(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	class UChildActorComponent*                        Damage_Zone_Middle_11;                                     // 0x0648(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	class UStaticMeshComponent*                        shp_small_hull_damage_01_a;                                // 0x0680(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_AISmallShip_StandardHull_Damage.BP_AISmallShip_StandardHull_Damage_C");
		return ptr;
	}
