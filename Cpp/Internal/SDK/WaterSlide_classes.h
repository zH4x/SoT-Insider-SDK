...
public:
	...
	unsigned char                                      UnknownData_M00Q[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_1S7U[0x3];                                     // 0x0409(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DFH6[0x20];                                    // 0x0420(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class WaterSlide.WaterSlideAudioParams");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_R2AH[0x10];                                    // 0x0230(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class WaterSlide.WaterSlideInputComponent");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_O51J[0x8];                                     // 0x00E0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UT5R[0x14];                                    // 0x00FC(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
