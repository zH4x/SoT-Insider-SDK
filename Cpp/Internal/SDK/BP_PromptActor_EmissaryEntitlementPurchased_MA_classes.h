...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryEntitlementPurchased_MA.BP_PromptActor_EmissaryEntitlementPurchased_MA_C");
		return ptr;
	}
