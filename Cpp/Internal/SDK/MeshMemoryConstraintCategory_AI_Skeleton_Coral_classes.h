...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass MeshMemoryConstraintCategory_AI_Skeleton_Coral.MeshMemoryConstraintCategory_AI_Skeleton_Coral_C");
		return ptr;
	}
