...
struct FVolcanoTargetChances
{
	...
	unsigned char                                      UnknownData_OFE2[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GR3Y[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FWeightedVolcanoProjectile
{
	...
	unsigned char                                      UnknownData_EYVX[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H5ZX[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVolcanoSetupDataEmbersEntry
{
	...
	unsigned char                                      UnknownData_67SK[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVolcanoStateData
{
	...
	unsigned char                                      UnknownData_BC2F[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVolcanoTarget
{
	...
	unsigned char                                      UnknownData_TVUI[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RFEZ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FVolcanoTargetCoolDown
{
	...
	unsigned char                                      UnknownData_41FP[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
