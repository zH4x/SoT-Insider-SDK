...
// 0x0230 (FullSize[0x07A8] - InheritedSize[0x0578])
class UGameplayDebuggingComponent : public UPrimitiveComponent
{
public:
	unsigned char                                      UnknownData_ZS5S[0x8];                                     // 0x0578(0x0008) Fix Super Size
	struct FString                                     DebugComponentClassName;                                   // 0x0580(0x0010) (ZeroConstructor, Config, GlobalConfig, HasGetValueTypeHash)
	int                                                ShowExtendedInformatiomCounter;                            // 0x0590(0x0004) (Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_YH9X[0x4];                                     // 0x0594(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<int>                                        ReplicateViewDataCounters;                                 // 0x0598(0x0010) (Net, ZeroConstructor)
	struct FString                                     ControllerName;                                            // 0x05A8(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     PawnName;                                                  // 0x05B8(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     PawnClass;                                                 // 0x05C8(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     DebugIcon;                                                 // 0x05D8(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     MovementBaseInfo;                                          // 0x05E8(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     MovementModeInfo;                                          // 0x05F8(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     PathFollowingInfo;                                         // 0x0608(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     CurrentAITask;                                             // 0x0618(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     CurrentAIState;                                            // 0x0628(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     CurrentAIAssets;                                           // 0x0638(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     GameplayTasksState;                                        // 0x0648(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     NavDataInfo;                                               // 0x0658(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     AbilityInfo;                                               // 0x0668(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     MontageInfo;                                               // 0x0678(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     BrainComponentName;                                        // 0x0688(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     BrainComponentString;                                      // 0x0698(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	TArray<unsigned char>                              BlackboardRepData;                                         // 0x06A8(0x0010) (Net, ZeroConstructor, RepNotify)
	unsigned char                                      UnknownData_HGUJ[0x10];                                    // 0x06B8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FVector>                             PathPoints;                                                // 0x06C8(0x0010) (Net, ZeroConstructor)
	TArray<unsigned char>                              PathCorridorData;                                          // 0x06D8(0x0010) (Net, ZeroConstructor, RepNotify)
	unsigned char                                      UnknownData_6M18[0x10];                                    // 0x06E8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<unsigned char>                              NavmeshRepData;                                            // 0x06F8(0x0010) (Net, ZeroConstructor, RepNotify)
	TArray<unsigned char>                              EQSRepData;                                                // 0x0708(0x0010) (Net, ZeroConstructor, RepNotify)
	struct FVector                                     SensingComponentLocation;                                  // 0x0718(0x000C) (Net, ZeroConstructor, IsPlainOldData, NoDestructor)
	int                                                NextPathPointIndex;                                        // 0x0724(0x0004) (Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      bIsUsingPathFollowing : 1;                                 // 0x0728(0x0001) BIT_FIELD (Net, NoDestructor)
	unsigned char                                      bIsUsingCharacter : 1;                                     // 0x0728(0x0001) BIT_FIELD (Net, NoDestructor)
	unsigned char                                      bIsUsingBehaviorTree : 1;                                  // 0x0728(0x0001) BIT_FIELD (Net, NoDestructor)
	unsigned char                                      bIsUsingAbilities : 1;                                     // 0x0728(0x0001) BIT_FIELD (Net, NoDestructor)
	unsigned char                                      UnknownData_3Q37[0x7];                                     // 0x0729(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class AActor*                                      TargetActor;                                               // 0x0730(0x0008) (Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_Q5X4[0x70];                                    // 0x0738(0x0070) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_U8EB[0xD0];                                    // 0x03F0(0x00D0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_C8L1[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_13Y9[0x1E];                                    // 0x008A(0x001E) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JD9N[0x28];                                    // 0x00E8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_7B2Z[0x30];                                    // 0x04C8(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_B388[0x4];                                     // 0x0404(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9Q2F[0x1];                                     // 0x0427(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S7KI[0x4E];                                    // 0x0432(0x004E) MISSED OFFSET (PADDING)
