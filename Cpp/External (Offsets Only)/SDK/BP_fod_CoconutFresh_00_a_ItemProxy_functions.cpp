...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_fod_CoconutFresh_00_a_ItemProxy.BP_fod_CoconutFresh_00_a_ItemProxy_C.UserConstructionScript");
...
void ABP_fod_CoconutFresh_00_a_ItemProxy_C::AfterRead()
{
	ABP_ProxyIngestible_C::AfterRead();

}

void ABP_fod_CoconutFresh_00_a_ItemProxy_C::BeforeDelete()
{
