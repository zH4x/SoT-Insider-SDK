...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_PromptActor_EmissaryEncounteredKraken_MA.BP_PromptActor_EmissaryEncounteredKraken_MA_C.UserConstructionScript");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_PromptActor_EmissaryEncounteredKraken_MA.BP_PromptActor_EmissaryEncounteredKraken_MA_C.ReceiveBeginPlay");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_PromptActor_EmissaryEncounteredKraken_MA.BP_PromptActor_EmissaryEncounteredKraken_MA_C.ReceiveEndPlay");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_PromptActor_EmissaryEncounteredKraken_MA.BP_PromptActor_EmissaryEncounteredKraken_MA_C.ExecuteUbergraph_BP_PromptActor_EmissaryEncounteredKraken_MA");
