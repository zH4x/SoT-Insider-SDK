...
void Awld_palm_cluster_04_d_C::AfterRead()
{
	...
	READ_PTR_FULL(wld_tree_palm_02_c_01, UStaticMeshComponent);
	READ_PTR_FULL(SharedRoot, USceneComponent);
}

void Awld_palm_cluster_04_d_C::BeforeDelete()
{
	...
	DELE_PTR_FULL(wld_tree_palm_02_c_01);
