...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_LotS_reward019.BP_LotS_reward019_C.UserConstructionScript");
...
void ABP_LotS_reward019_C::AfterRead()
{
...
void ABP_LotS_reward019_C::BeforeDelete()
{
