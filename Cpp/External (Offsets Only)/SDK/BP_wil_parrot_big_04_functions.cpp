...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_wil_parrot_big_04.BP_wil_parrot_big_04_C.UserConstructionScript");
...
void ABP_wil_parrot_big_04_C::AfterRead()
{
	AActor::AfterRead();
...
void ABP_wil_parrot_big_04_C::BeforeDelete()
{
	AActor::BeforeDelete();
