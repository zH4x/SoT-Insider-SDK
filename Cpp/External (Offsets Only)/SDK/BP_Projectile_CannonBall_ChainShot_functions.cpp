...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Projectile_CannonBall_ChainShot.BP_Projectile_CannonBall_ChainShot_C.UserConstructionScript");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Projectile_CannonBall_ChainShot.BP_Projectile_CannonBall_ChainShot_C.ReceiveBeginPlay");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Projectile_CannonBall_ChainShot.BP_Projectile_CannonBall_ChainShot_C.ExecuteUbergraph_BP_Projectile_CannonBall_ChainShot");
...
void ABP_Projectile_CannonBall_ChainShot_C::AfterRead()
{
	ACannonProjectile::AfterRead();

	READ_PTR_FULL(MeshRotator, UMeshRotatorComponent);
	READ_PTR_FULL(BoxCollisionExtentAdjustOverTime, UBoxCollisionExtentAdjustOverTimeComponent);
	READ_PTR_FULL(chainshot, UStaticMeshComponent);
	READ_PTR_FULL(Collision, UBoxComponent);
}

void ABP_Projectile_CannonBall_ChainShot_C::BeforeDelete()
{
	ACannonProjectile::BeforeDelete();

	DELE_PTR_FULL(MeshRotator);
	DELE_PTR_FULL(BoxCollisionExtentAdjustOverTime);
	DELE_PTR_FULL(chainshot);
