...
{
public:
	unsigned char                                      UnknownData_Z1RE[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K57B[0x110];                                   // 0x0400(0x0110) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IGF8[0x118];                                   // 0x03D0(0x0118) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_X8YB[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
