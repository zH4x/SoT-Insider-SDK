...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_fod_CoconutFresh_00_a_Wieldable.BP_fod_CoconutFresh_00_a_Wieldable_C.UserConstructionScript");
...
void ABP_fod_CoconutFresh_00_a_Wieldable_C::AfterRead()
{
	ABP_StaticWieldableIngestible_C::AfterRead();

}

void ABP_fod_CoconutFresh_00_a_Wieldable_C::BeforeDelete()
{
