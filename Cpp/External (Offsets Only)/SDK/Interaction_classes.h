...
{
public:
	unsigned char                                      UnknownData_81P1[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IS1C[0x3];                                     // 0x00FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_REBZ[0x5];                                     // 0x0103(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_053M[0x7];                                     // 0x0111(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WRLI[0x8];                                     // 0x05A8(0x0008) Fix Super Size
	class UInteractableArea*                           CurrentOptimalInteractable;                                // 0x05B0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_V4P5[0xB8];                                    // 0x05B8(0x00B8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_6C3O[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class Interaction.InteractableBlueprintFunctionLibrary");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_IRG7[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UInteractableArea*>                   InteractableAreas;                                         // 0x0038(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData_XJQQ[0x28];                                    // 0x0048(0x0028) MISSED OFFSET (PADDING)
...
// 0x00B8 (FullSize[0x0680] - InheritedSize[0x05C8])
class AMockActorWithCharacterInteractionComponent : public ACharacter
{
public:
	unsigned char                                      UnknownData_J2KW[0x8];                                     // 0x05C8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_GPPH[0x8];                                     // 0x05D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UCharacterInteractionComponent*              CharacterInteractionComponent;                             // 0x05D8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_JAX5[0xA0];                                    // 0x05E0(0x00A0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7SUG[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JUTU[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_11FP[0x8];                                     // 0x03F0(0x0008) MISSED OFFSET (PADDING)
