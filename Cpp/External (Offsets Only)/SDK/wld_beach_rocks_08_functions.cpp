...
void Awld_beach_rocks_08_C::AfterRead()
{
	ABP_Placement_HeightDrop_C::AfterRead();

	READ_PTR_FULL(wld_rock_small_01__d, UStaticMeshComponent);
	READ_PTR_FULL(wld_rock_small_01__a, UStaticMeshComponent);
	READ_PTR_FULL(wld_rock_medium_01__a1, UStaticMeshComponent);
	READ_PTR_FULL(wld_rock_medium_01__e1, UStaticMeshComponent);
	...
	READ_PTR_FULL(wld_rock_large_01__b1, UStaticMeshComponent);
	READ_PTR_FULL(SharedRoot, USceneComponent);
}

void Awld_beach_rocks_08_C::BeforeDelete()
{
	ABP_Placement_HeightDrop_C::BeforeDelete();

	DELE_PTR_FULL(wld_rock_small_01__d);
	DELE_PTR_FULL(wld_rock_small_01__a);
	DELE_PTR_FULL(wld_rock_medium_01__a1);
	DELE_PTR_FULL(wld_rock_medium_01__e1);
	...
	DELE_PTR_FULL(wld_rock_large_01__b1);
