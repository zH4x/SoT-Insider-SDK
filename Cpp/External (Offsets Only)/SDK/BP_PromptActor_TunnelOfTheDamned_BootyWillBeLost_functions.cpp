...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_PromptActor_TunnelOfTheDamned_BootyWillBeLost.BP_PromptActor_TunnelOfTheDamned_BootyWillBeLost_C.UserConstructionScript");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_PromptActor_TunnelOfTheDamned_BootyWillBeLost.BP_PromptActor_TunnelOfTheDamned_BootyWillBeLost_C.ReceiveBeginPlay");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_PromptActor_TunnelOfTheDamned_BootyWillBeLost.BP_PromptActor_TunnelOfTheDamned_BootyWillBeLost_C.ReceiveEndPlay");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_PromptActor_TunnelOfTheDamned_BootyWillBeLost.BP_PromptActor_TunnelOfTheDamned_BootyWillBeLost_C.ExecuteUbergraph_BP_PromptActor_TunnelOfTheDamned_BootyWillBeLost");
...
void ABP_PromptActor_TunnelOfTheDamned_BootyWillBeLost_C::AfterRead()
{
	ABP_PromptActorBase_C::AfterRead();

	READ_PTR_FULL(PromptCoordinator, UBP_Prompt_TunnelOfTheDamned_BootyWillBeLost_C);
}

void ABP_PromptActor_TunnelOfTheDamned_BootyWillBeLost_C::BeforeDelete()
{
