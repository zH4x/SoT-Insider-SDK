...
// 0x00C4 (FullSize[0x01DC] - InheritedSize[0x0118])
...
public:
	...
	unsigned char                                      UnknownData_QWX6[0x2];                                     // 0x01D6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Prompt_TunnelOfTheDamned_BootyWillBeLost.BP_Prompt_TunnelOfTheDamned_BootyWillBeLost_C");
		return ptr;
	}
