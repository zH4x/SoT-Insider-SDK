...
{
public:
	unsigned char                                      UnknownData_XIG8[0x10];                                    // 0x0078(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class AActor*                                      HealAreaOfEffectActor;                                     // 0x0088(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_VV11[0x10];                                    // 0x0090(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_J065[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WL3S[0x2F];                                    // 0x00E9(0x002F) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AthenaAIAbilities.BurrowHealVFXComponent");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_1HUY[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XNFT[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DQD3[0x70];                                    // 0x0100(0x0070) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_U4WZ[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_X1O6[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AthenaAIAbilities.MeleeCollisionAwarenessInterface");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_JW68[0x38];                                    // 0x00C8(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Z3A0[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AthenaAIAbilities.StatusResponseShowBurrowHealVFX");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AthenaAIAbilities.StatusResponseShowCoralShieldVFX");
		return ptr;
	}
