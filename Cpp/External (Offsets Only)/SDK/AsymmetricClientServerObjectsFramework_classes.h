...
{
public:
	unsigned char                                      UnknownData_29HL[0x18];                                    // 0x03D0(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("Class AsymmetricClientServerObjectsFramework.AsymmetricClientObject");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_3P3W[0x18];                                    // 0x03D0(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IDRK[0x4];                                     // 0x0408(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AsymmetricClientServerObjectsFramework.AsymmetricObjectServerManager");
		return ptr;
	}
