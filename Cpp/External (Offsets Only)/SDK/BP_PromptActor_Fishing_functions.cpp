...
void ABP_PromptActor_Fishing_C::AfterRead()
{
	ABP_PromptActorBase_C::AfterRead();

	READ_PTR_FULL(PromptCoordinator, UBP_Prompt_MaidenVoyage_FishingRodTutorial_C);
}

void ABP_PromptActor_Fishing_C::BeforeDelete()
{
