...
public:
	...
	unsigned char                                      UnknownData_BO94[0x1A4];                                   // 0x006C(0x01A4) MISSED OFFSET (PADDING)
...
// 0x0168 (FullSize[0x06E0] - InheritedSize[0x0578])
class ULandscapeComponent : public UPrimitiveComponent
{
public:
	unsigned char                                      UnknownData_NM85[0x4];                                     // 0x0578(0x0004) Fix Super Size
	int                                                SectionBaseY;                                              // 0x057C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                ComponentSizeQuads;                                        // 0x0580(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                SubsectionSizeQuads;                                       // 0x0584(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                NumSubsections;                                            // 0x0588(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_QMXE[0x4];                                     // 0x058C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UMaterialInterface*                          OverrideMaterial;                                          // 0x0590(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UMaterialInterface*                          OverrideHoleMaterial;                                      // 0x0598(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash)
	class UMaterialInstanceConstant*                   MaterialInstance;                                          // 0x05A0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, TextExportTransient, HasGetValueTypeHash)
	TArray<struct FWeightmapLayerAllocationInfo>       WeightmapLayerAllocations;                                 // 0x05A8(0x0010) (ZeroConstructor)
	TArray<class UTexture2D*>                          WeightmapTextures;                                         // 0x05B8(0x0010) (ZeroConstructor, TextExportTransient)
	class UTexture2D*                                  XYOffsetmapTexture;                                        // 0x05C8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, TextExportTransient, HasGetValueTypeHash)
	struct FVector4                                    WeightmapScaleBias;                                        // 0x05D0(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
	float                                              WeightmapSubsectionOffset;                                 // 0x05E0(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_3L8Y[0xC];                                     // 0x05E4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FVector4                                    HeightmapScaleBias;                                        // 0x05F0(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
	class UTexture2D*                                  HeightmapTexture;                                          // 0x0600(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, TextExportTransient, HasGetValueTypeHash)
	struct FBox                                        CachedLocalBox;                                            // 0x0608(0x001C) (ZeroConstructor, IsPlainOldData, NoDestructor)
	TLazyObjectPtr<class ULandscapeHeightfieldCollisionComponent> CollisionComponent;                                        // 0x0624(0x001C) (ExportObject, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	TArray<struct FGuid>                               IrrelevantLights;                                          // 0x0640(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_37DO[0x10];                                    // 0x0650(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                CollisionMipLevel;                                         // 0x0660(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                              StaticLightingResolution;                                  // 0x0664(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                ForcedLOD;                                                 // 0x0668(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                LODBias;                                                   // 0x066C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGuid                                       StateId;                                                   // 0x0670(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FGuid                                       BakedTextureMaterialGuid;                                  // 0x0680(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
	class UTexture2D*                                  GIBakedBaseColorTexture;                                   // 0x0690(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      MobileBlendableLayerMask;                                  // 0x0698(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_IDZK[0x7];                                     // 0x0699(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UMaterialInterface*                          MobileMaterialInterface;                                   // 0x06A0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, NonPIEDuplicateTransient, HasGetValueTypeHash)
	class UTexture2D*                                  MobileWeightNormalmapTexture;                              // 0x06A8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, NonPIEDuplicateTransient, HasGetValueTypeHash)
	unsigned char                                      UnknownData_9138[0x30];                                    // 0x06B0(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_I336[0x50];                                    // 0x03D0(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0Y8Q[0x8];                                     // 0x0578(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_XSDW[0x6];                                     // 0x0052(0x0006) MISSED OFFSET (PADDING)
...
{
public:
	TArray<class ULandscapeLayerInfoObject*>           ComponentLayerInfos;                                       // 0x0578(0x0010) (ZeroConstructor)
	int                                                SectionBaseX;                                              // 0x0588(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                SectionBaseY;                                              // 0x058C(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                CollisionSizeQuads;                                        // 0x0590(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                              CollisionScale;                                            // 0x0594(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<unsigned char>                              CollisionQuadFlags;                                        // 0x0598(0x0010) (ZeroConstructor)
	struct FGuid                                       HeightfieldGuid;                                           // 0x05A8(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FBox                                        CachedLocalBox;                                            // 0x05B8(0x001C) (ZeroConstructor, IsPlainOldData, NoDestructor)
	TLazyObjectPtr<class ULandscapeComponent>          RenderComponent;                                           // 0x05D4(0x001C) (ExportObject, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	unsigned char                                      UnknownData_S088[0x10];                                    // 0x05F0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UPhysicalMaterial*>                   CookedPhysicalMaterials;                                   // 0x0600(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_0HP8[0x40];                                    // 0x0610(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	struct FGuid                                       MeshGuid;                                                  // 0x0650(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_6YI8[0x10];                                    // 0x0660(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_07MO[0x50];                                    // 0x0028(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ED3L[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YWE2[0x3];                                     // 0x01B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J8DP[0x4];                                     // 0x01BC(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YZ1U[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VSZX[0x4];                                     // 0x040C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A91O[0x4];                                     // 0x0424(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PQOQ[0x78];                                    // 0x0458(0x0078) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IT8Q[0x3];                                     // 0x04F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_34QU[0x3];                                     // 0x06AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JTOB[0xAE];                                    // 0x06B2(0x00AE) MISSED OFFSET (PADDING)
...
{
public:
	struct FGuid                                       LandscapeGuid;                                             // 0x05E0(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
	TArray<struct FIntPoint>                           ProxyComponentBases;                                       // 0x05F0(0x0010) (ZeroConstructor)
	int8_t                                             ProxyLOD;                                                  // 0x0600(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_5CIM[0xF];                                     // 0x0601(0x000F) MISSED OFFSET (PADDING)
...
{
public:
	TArray<class ULandscapeSplineControlPoint*>        ControlPoints;                                             // 0x0578(0x0010) (ZeroConstructor, Protected, TextExportTransient)
	TArray<class ULandscapeSplineSegment*>             Segments;                                                  // 0x0588(0x0010) (ZeroConstructor, Protected, TextExportTransient)
	TArray<class UMeshComponent*>                      CookedForeignMeshComponents;                               // 0x0598(0x0010) (ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, TextExportTransient)
	unsigned char                                      UnknownData_GCTX[0x8];                                     // 0x05A8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_8Q20[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_CND3[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MDE6[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_W9XH[0x2];                                     // 0x0072(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RR3L[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_OQWP[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_E3FX[0x3];                                     // 0x00E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGuid                                       ExpressionGUID;                                            // 0x00EC(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_AHXE[0x4];                                     // 0x00FC(0x0004) MISSED OFFSET (PADDING)
