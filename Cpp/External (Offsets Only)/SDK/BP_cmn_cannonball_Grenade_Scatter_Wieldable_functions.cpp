...
void ABP_cmn_cannonball_Grenade_Scatter_Wieldable_C::AfterRead()
{
	ABP_Grenade_Wieldable_C::AfterRead();

	READ_PTR_FULL(DynamicMaterial, UMaterialInstanceDynamic);
}

void ABP_cmn_cannonball_Grenade_Scatter_Wieldable_C::BeforeDelete()
{
	ABP_Grenade_Wieldable_C::BeforeDelete();
