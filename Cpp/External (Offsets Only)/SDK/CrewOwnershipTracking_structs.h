...
struct FCrewTrackedItemOwnershipChanged
{
	...
	unsigned char                                      UnknownData_R4OF[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FTrackItemOwnershipEvent
{
	...
	TScriptInterface<class UCrewMembershipInterface>   CrewMembershipInterface;                                   // 0x0008(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper)
