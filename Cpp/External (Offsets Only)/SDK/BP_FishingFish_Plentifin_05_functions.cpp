...
void ABP_FishingFish_Plentifin_05_C::AfterRead()
{
	ABP_FishingFish_Plentifin_Base_C::AfterRead();

}

void ABP_FishingFish_Plentifin_05_C::BeforeDelete()
{
	ABP_FishingFish_Plentifin_Base_C::BeforeDelete();
