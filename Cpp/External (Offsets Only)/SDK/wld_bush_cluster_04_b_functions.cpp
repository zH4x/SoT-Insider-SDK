...
{
	static auto fn = UObject::FindObject<UFunction>("Function wld_bush_cluster_04_b.wld_bush_cluster_04_b_C.UserConstructionScript");
...
void Awld_bush_cluster_04_b_C::AfterRead()
{
...
void Awld_bush_cluster_04_b_C::BeforeDelete()
{
