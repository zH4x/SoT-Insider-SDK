...
{
	unsigned char                                      UnknownData_0LQF[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FTaleQuestCargoRunContractItem
{
	...
	unsigned char                                      UnknownData_RZ1M[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FTaleQuestDesc : public FQuestDesc
{
	...
	unsigned char                                      UnknownData_5DU8[0x20];                                    // 0x0038(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_MHOO[0x6];                                     // 0x007A(0x0006) MISSED OFFSET (PADDING)
...
struct FTrackedActorData
{
	...
	unsigned char                                      UnknownData_83NQ[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FCriticalActorDelegateData
{
	...
	unsigned char                                      UnknownData_R8SH[0x20];                                    // 0x0008(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_95S6[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
{
	class AActor*                                      CriticalActor;                                             // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_4G8K[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
...
struct FPhasedItem
{
	...
	unsigned char                                      UnknownData_WMTO[0x17];                                    // 0x0011(0x0017) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CE40[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JS28[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FStepMerchantItemDesc
{
	...
	unsigned char                                      UnknownData_RL13[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	struct FText                                       Name;                                                      // 0x0000(0x0018) ELEMENT_SIZE_MISMATCH (Edit, BlueprintVisible)
	unsigned char                                      UnknownData_776K[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	class UTexture*                                    Icon;                                                      // 0x0038(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
	struct FText                                       Name;                                                      // 0x0000(0x0018) ELEMENT_SIZE_MISMATCH (Edit, BlueprintVisible)
	unsigned char                                      UnknownData_U6IB[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FTaleQuestDeliveryRequest
{
	...
	unsigned char                                      UnknownData_NFUT[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPhasedActor
{
	...
	unsigned char                                      UnknownData_JVBJ[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
