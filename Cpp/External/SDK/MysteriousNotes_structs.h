...
{
	unsigned char                                      UnknownData_WS3G[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FMysteriousNoteInfo
{
	...
	unsigned char                                      UnknownData_16GZ[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (PADDING)
...
struct FPlayerMysteriousNoteItem
{
	...
	unsigned char                                      UnknownData_9XYY[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
struct FWieldableMysteriousNoteLayoutItem
{
	...
	unsigned char                                      UnknownData_2Y6L[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FClientNoteData
{
	...
	unsigned char                                      UnknownData_FMXD[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_6JVR[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventTriggerMysteriousNotesPopup
{
	...
	unsigned char                                      UnknownData_2WLX[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AGZN[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_P6GU[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WKLD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
