...
// 0x0038 (FullSize[0x0618] - InheritedSize[0x05E0])
class UCordRenderComponent : public UStaticMeshComponent
{
public:
	unsigned char                                      UnknownData_6AYN[0x8];                                     // 0x05E0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UMaterialInstanceDynamic*>            CordMaterials;                                             // 0x05E8(0x0010) (ZeroConstructor, Transient, Protected)
	float                                              ThicknessCm;                                               // 0x05F8(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash)
	unsigned char                                      UnknownData_FEYC[0x1C];                                    // 0x05FC(0x001C) Fix Super Size
...
// 0x0068 (FullSize[0x0680] - InheritedSize[0x0618])
class UDynamicCordRenderComponent : public UCordRenderComponent
{
public:
	unsigned char                                      UnknownData_KGBP[0x8];                                     // 0x0618(0x0008) Fix Super Size
	class USceneComponent*                             EndPointA;                                                 // 0x0620(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class USceneComponent*                             EndPointB;                                                 // 0x0628(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_T9OM[0x50];                                    // 0x0630(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	TArray<class UMaterialInstanceDynamic*>            HarpoonMaterials;                                          // 0x0618(0x0010) (ZeroConstructor, Transient)
	float                                              LaunchAnimationDurationSecs;                               // 0x0628(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                              HitAnimationDurationSecs;                                  // 0x062C(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                              QuickRetractAnimationSpeed;                                // 0x0630(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_CL2E[0xC];                                     // 0x0634(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_T2LV[0x70];                                    // 0x00C8(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ROU8[0x5];                                     // 0x014B(0x0005) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BIOR[0xF8];                                    // 0x03D0(0x00F8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QB29[0x8];                                     // 0x0500(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WCI6[0x3];                                     // 0x050D(0x0003) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LO5W[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MCTF[0x48];                                    // 0x00D8(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5COE[0x2];                                     // 0x0126(0x0002) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BAT7[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (PADDING)
