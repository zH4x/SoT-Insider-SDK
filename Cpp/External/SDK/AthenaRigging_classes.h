...
// 0x00C8 (FullSize[0x0640] - InheritedSize[0x0578])
class UInstancedRopeComponent : public UPrimitiveComponent
{
public:
	class UStaticMesh*                                 StaticMesh;                                                // 0x0578(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<struct FInstancedRopeParams>                Ropes;                                                     // 0x0580(0x0010) (Edit, ZeroConstructor, EditConst)
	int                                                ShadowLOD;                                                 // 0x0590(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_9OHF[0xAC];                                    // 0x0594(0x00AC) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MJIQ[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0IHU[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UDIL[0x88];                                    // 0x0498(0x0088) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_S8FU[0x8];                                     // 0x02E8(0x0008) MISSED OFFSET (PADDING)
...
// 0x0008 (FullSize[0x0620] - InheritedSize[0x0618])
class URopeCatenaryRenderComponent : public UCordRenderComponent
{
public:
	unsigned char                                      UnknownData_1J4H[0x8];                                     // 0x0618(0x0008) Fix Super Size
