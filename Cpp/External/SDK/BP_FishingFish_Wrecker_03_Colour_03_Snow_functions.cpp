...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_FishingFish_Wrecker_03_Colour_03_Snow.BP_FishingFish_Wrecker_03_Colour_03_Snow_C.UserConstructionScript");
...
void ABP_FishingFish_Wrecker_03_Colour_03_Snow_C::AfterRead()
{
	ABP_FishingFish_Wrecker_03_C::AfterRead();

}

void ABP_FishingFish_Wrecker_03_Colour_03_Snow_C::BeforeDelete()
{
