...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryEncounteredSkellyFort_OOS.BP_PromptActor_EmissaryEncounteredSkellyFort_OOS_C");
		return ptr;
	}
