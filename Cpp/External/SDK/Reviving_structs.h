...
struct FModeSpecificReviveSettings
{
	...
	unsigned char                                      UnknownData_3ZMH[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FReviveEffectsValues
{
	...
	unsigned char                                      UnknownData_12A7[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H4UI[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FKN1[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FReviveableActionStateConstructionInfo : public FActorActionStateConstructionInfo
{
	...
	unsigned char                                      UnknownData_XZ97[0x6];                                     // 0x0062(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8CZ2[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_11TX[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QIUL[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8IG2[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_E524[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J4AP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6P1X[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FX5Z[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DLPT[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LR7W[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_71WK[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FRevivingWindowStart
{
	...
	unsigned char                                      UnknownData_XKF3[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
