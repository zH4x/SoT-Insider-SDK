...
public:
	...
	unsigned char                                      UnknownData_D5WW[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TILH[0x18];                                    // 0x0110(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3DOQ[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
