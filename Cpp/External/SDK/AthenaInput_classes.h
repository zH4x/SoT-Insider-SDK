...
{
public:
	unsigned char                                      UnknownData_B7TB[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KACA[0xB0];                                    // 0x0028(0x00B0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5N7E[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_H0XM[0x58];                                    // 0x0030(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_55H9[0x50];                                    // 0x0028(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_44AM[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (PADDING)
...
// 0x0008 (FullSize[0x05D0] - InheritedSize[0x05C8])
class AMockInputHandlerCharacter : public ACharacter
{
public:
	unsigned char                                      UnknownData_QBXG[0x8];                                     // 0x05C8(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_J9K8[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AthenaInput.CrewNameplatesToggleInputId");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AthenaInput.ScrambleGamertagsToggleInputId");
		return ptr;
	}
