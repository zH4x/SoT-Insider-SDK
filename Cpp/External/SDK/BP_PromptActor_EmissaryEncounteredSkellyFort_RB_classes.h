...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryEncounteredSkellyFort_RB.BP_PromptActor_EmissaryEncounteredSkellyFort_RB_C");
		return ptr;
	}
