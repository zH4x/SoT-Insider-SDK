...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_AIShipStorageBarrel_Cannonball.BP_AIShipStorageBarrel_Cannonball_C.UserConstructionScript");

	ABP_AIShipStorageBarrel_Cannonball_C_UserConstructionScript_Params params;
...
void ABP_AIShipStorageBarrel_Cannonball_C::AfterRead()
{
...
void ABP_AIShipStorageBarrel_Cannonball_C::BeforeDelete()
{
