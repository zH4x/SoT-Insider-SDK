...
struct FOceanCrawlerAnimationDataStructure
{
	...
	struct FCustomAnimationMontageId                   DeathMontageId;                                            // 0x0060(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FCustomAnimationMontageId                   SpawnMontageId;                                            // 0x0068(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FCustomAnimationMontageId                   SpawnOnShipMontageId;                                      // 0x0070(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FCustomAnimationMontageId                   SpawnBoardedMontageId;                                     // 0x0078(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
