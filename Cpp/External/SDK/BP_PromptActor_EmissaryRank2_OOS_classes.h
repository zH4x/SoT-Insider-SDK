...
public:
	...
	unsigned char                                      UnknownData_YHXL[0x4];                                     // 0x042C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryRank2_OOS.BP_PromptActor_EmissaryRank2_OOS_C");
		return ptr;
	}
