...
void ABP_Campaign005_CursedSails_WeapondealerWillow_PreCursedSails_C::AfterRead()
{
	ABP_Weapondealer_C::AfterRead();

}

void ABP_Campaign005_CursedSails_WeapondealerWillow_PreCursedSails_C::BeforeDelete()
{
