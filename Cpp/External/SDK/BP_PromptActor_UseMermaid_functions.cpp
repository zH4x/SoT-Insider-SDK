...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_PromptActor_UseMermaid.BP_PromptActor_UseMermaid_C.UserConstructionScript");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_PromptActor_UseMermaid.BP_PromptActor_UseMermaid_C.ReceiveBeginPlay");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_PromptActor_UseMermaid.BP_PromptActor_UseMermaid_C.ReceiveEndPlay");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_PromptActor_UseMermaid.BP_PromptActor_UseMermaid_C.ExecuteUbergraph_BP_PromptActor_UseMermaid");
...
void ABP_PromptActor_UseMermaid_C::AfterRead()
{
	ABP_PromptActorBase_C::AfterRead();

	READ_PTR_FULL(PromptCoordinator, UBP_Prompt_UseAMermaid_C);
}

void ABP_PromptActor_UseMermaid_C::BeforeDelete()
{
